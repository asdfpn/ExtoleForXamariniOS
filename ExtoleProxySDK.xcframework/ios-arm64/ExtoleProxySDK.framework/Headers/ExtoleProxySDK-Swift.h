...
#ifndef EXTOLEPROXYSDK_SWIFT_H
#define EXTOLEPROXYSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ExtoleProxySDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_PROTOCOL("_TtP14ExtoleProxySDK6Extole_")
@protocol Extole
- (void)initFor:(NSString * _Nonnull)programDomain :(NSString * _Nonnull)applicationName SWIFT_METHOD_FAMILY(none);
...
- (UIViewController * _Nonnull)getView SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_PROTOCOL("_TtP14ExtoleProxySDK9ICampaign_")
@protocol ICampaign <Extole>
- (NSString * _Nullable)getProgram SWIFT_WARN_UNUSED_RESULT;
- (id <IId> _Nonnull)getId SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC14ExtoleProxySDK10ExtoleImpl")
...
SWIFT_CLASS("_TtC14ExtoleProxySDK8Campaign")
...
SWIFT_PROTOCOL("_TtP14ExtoleProxySDK3IId_")
@protocol IId
- (NSString * _Nullable)getValue SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_PROTOCOL("_TtP14ExtoleProxySDK5IZone_")
@protocol IZone
- (NSString * _Nullable)getName SWIFT_WARN_UNUSED_RESULT;
- (void)tap;
- (void)viewed;
- (id _Nullable)get:(NSString * _Nonnull)dottedPath SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC14ExtoleProxySDK2Id")
...
SWIFT_CLASS("_TtC14ExtoleProxySDK4Zone")
